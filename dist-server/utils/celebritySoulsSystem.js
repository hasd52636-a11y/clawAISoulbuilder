...
exports.CELEBRITY_SOULS = exports.FERRISS_SOUL = exports.KONDO_SOUL = exports.QIANYESEN_SOUL = exports.BUFFETT_SOUL = exports.DRUCKER_SOUL = exports.BOWIE_SOUL = exports.MURAKAMI_SOUL = exports.JOBS_SOUL = exports.NADELLA_SOUL = exports.GROVE_SOUL = exports.HUANG_SOUL = exports.BEZOS_SOUL = exports.MUSK_SOUL = void 0;
exports.getCelebritySoul = getCelebritySoul;
exports.listCelebritySouls = listCelebritySouls;
exports.convertSoulToAgentConfig = convertSoulToAgentConfig;
// 1. 马斯克 - 钢铁战神型
exports.MUSK_SOUL = {
    id: 'musk',
    name: 'Elon Musk',
...
exports.CELEBRITY_SOULS = {
    musk: exports.MUSK_SOUL,
    bezos: exports.BEZOS_SOUL,
    huang: exports.HUANG_SOUL,
    grove: exports.GROVE_SOUL,
    nadella: exports.NADELLA_SOUL,
    jobs: exports.JOBS_SOUL,
    murakami: exports.MURAKAMI_SOUL,
    bowie: exports.BOWIE_SOUL,
    drucker: exports.DRUCKER_SOUL,
    buffett: exports.BUFFETT_SOUL,
    qianxuesen: exports.QIANYESEN_SOUL,
    kondo: exports.KONDO_SOUL,
    ferriss: exports.FERRISS_SOUL,
};
// Helper function to get celebrity soul by ID
function getCelebritySoul(id) {
    return exports.CELEBRITY_SOULS[id];
}
// Helper function to list all celebrity souls
function listCelebritySouls() {
    return Object.values(exports.CELEBRITY_SOULS).map(soul => ({
        id: soul.id,
        name: soul.name,
        nameZh: soul.nameZh,
...
function convertSoulToAgentConfig(soul) {
    return {
        name: soul.nameZh,
        role: soul.archetype,
        version: '1.0',
