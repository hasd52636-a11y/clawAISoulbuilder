...
exports.EXTENDED_TOOLS = exports.BASE_TOOLS = exports.VIBE = exports.BOUNDARIES = exports.CORE_TRUTHS = void 0;
exports.generateSOUL = generateSOUL;
exports.generateIDENTITY = generateIDENTITY;
exports.generateTOOLS = generateTOOLS;
exports.generateMEMORY = generateMEMORY;
exports.generateCOLLABORATION = generateCOLLABORATION;
exports.generateAllTemplates = generateAllTemplates;
exports.downloadTemplates = downloadTemplates;
exports.generateOpenclawGuidance = generateOpenclawGuidance;
exports.generateSkillFile = generateSkillFile;
exports.generateAllGuidance = generateAllGuidance;
...
exports.VIBE = "Be the assistant you\'d actually want to talk to. Concise when needed, thorough when it matters. Not a corporate drone. Not a sycophant. Just... good.";
...
function generateSOUL(config) {
    const coreTruths = config.coreTruths?.length ? config.coreTruths : exports.CORE_TRUTHS;
    const boundaries = config.boundaries?.length ? config.boundaries : exports.BOUNDARIES;
    const vibe = config.vibe || exports.VIBE;
...
function generateTOOLS(config) {
    const allTools = [...exports.BASE_TOOLS, ...exports.EXTENDED_TOOLS];
    const soul = config.celebritySoul;
...
**Base Tools**: ${exports.BASE_TOOLS.length} tools
**Extended Tools**: ${exports.EXTENDED_TOOLS.length} tools
`;
}
...
function generateCOLLABORATION(config) {
...
function generateAllTemplates(config) {
    return {
...
function downloadTemplates(templates) {
...
function generateOpenclawGuidance(config) {
    let channelsSection = '';
...
function generateAllGuidance(config) {
    return {
