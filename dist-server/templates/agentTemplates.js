...
exports.TEMPLATE_METADATA = exports.TEMPLATES = void 0;
exports.getTemplate = getTemplate;
exports.getTemplateMetadata = getTemplateMetadata;
exports.getAllTemplates = getAllTemplates;
exports.customizeTemplate = customizeTemplate;
exports.generateAgentConfig = generateAgentConfig;
const agentTemplateGenerator_1 = require("../utils/agentTemplateGenerator");
const celebritySoulsSystem_1 = require("../utils/celebritySoulsSystem");
...
exports.TEMPLATES = {
    developer: {
        ...
        agentType: 'main',
        coreTruths: [
            ...agentTemplateGenerator_1.CORE_TRUTHS.slice(0, 3), // Be helpful, have opinions, be resourceful
            "Code should be readable, not clever. Tests are documentation.",
            "I tell the story of your code. Every bug has a narrative.",
        ],
        boundaries: [
            ...agentTemplateGenerator_1.BOUNDARIES,
        ...
        tools: [...agentTemplateGenerator_1.BASE_TOOLS, ...agentTemplateGenerator_1.EXTENDED_TOOLS, 'github', 'gitlab', 'npm'],
        memoryType: 'hybrid',
    ...
    researcher: {
        ...
        tools: [...agentTemplateGenerator_1.BASE_TOOLS, 'web_search', 'web_fetch', 'scholar', 'arxiv'],
        memoryType: 'vector',
    ...
    writer: {
        ...
        tools: [...agentTemplateGenerator_1.BASE_TOOLS, 'grammar', 'spellcheck', 'thesaurus'],
        memoryType: 'local',
    ...
    analyst: {
        ...
        tools: [...agentTemplateGenerator_1.BASE_TOOLS, 'sql', 'python', 'excel', 'visualization'],
        memoryType: 'hybrid',
        collaborationMode: 'hybrid',
    },
    collaborator: {
        ...
        tools: [...agentTemplateGenerator_1.BASE_TOOLS, 'calendar', 'tasks', 'notifications', 'video'],
        memoryType: 'api',
        collaborationMode: 'parallel',
    },
    musk: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.musk),
    bezos: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.bezos),
    huang: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.huang),
    grove: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.grove),
    nadella: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.nadella),
    jobs: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.jobs),
    murakami: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.murakami),
    bowie: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.bowie),
    drucker: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.drucker),
    buffett: (0, celebritySoulsSystem_1.convertSoulToAgentConfig)(celebritySoulsSystem_1.CELEBRITY_SOULS.buffett),
    custom: {
        name: 'CustomAgent',
        role: '自定义',
        version: '1.0',
        agentType: 'main',
        coreTruths: agentTemplateGenerator_1.CORE_TRUTHS,
        boundaries: agentTemplateGenerator_1.BOUNDARIES,
        vibe: agentTemplateGenerator_1.VIBE,
        tools: [...agentTemplateGenerator_1.BASE_TOOLS, ...agentTemplateGenerator_1.EXTENDED_TOOLS],
        memoryType: 'hybrid',
        collaborationMode: 'hybrid',
    },
};
exports.TEMPLATE_METADATA = {
    developer: {
        id: 'developer',
        name: '开发大师',
...
function getTemplate(category) {
    return exports.TEMPLATES[category];
}
function getTemplateMetadata(category) {
    return exports.TEMPLATE_METADATA[category];
}
function getAllTemplates() {
    return Object.entries(exports.TEMPLATE_METADATA).map(([category, metadata]) => ({
        category: category,
        metadata,
    }));
}
function customizeTemplate(category, overrides) {
    const base = exports.TEMPLATES[category];
    return { ...base, ...overrides };
}
// Generate complete agent configuration files from a celebrity soul
function generateAgentConfig(soul, agentName, customizations) {
...
### 决策原则
${soul.efficiencyMode?.principles?.map((p, i) => `${i + 1}. ${p}`).join('\n') || '1. 效率优先\n2. 质量保证\n3. 持续改进'}

## 💼 专业领域

### 核心技能
${soul.workMethod?.keyFocus?.map((f) => `- **${f}**: 专业能力`).join('\n') || '- **分析**: 深度分析能力\n- **执行**: 高效执行能力\n- **创新**: 创新思维能力'}
...
### 核心职责
${soul.workMethod?.keyFocus?.map((f, i) => `${i + 1}. ${f}`).join('\n') || '1. 任务执行\n2. 问题解决\n3. 结果交付'}
...
### 推荐工具
${soul.toolsRecommendation?.map((t) => `| ${t} | ✅ | 专业工具 | 推荐使用 |`).join('\n') || '| 分析工具 | ✅ | 数据分析 | 推荐使用 |\n| 执行工具 | ✅ | 任务执行 | 推荐使用 |'}
